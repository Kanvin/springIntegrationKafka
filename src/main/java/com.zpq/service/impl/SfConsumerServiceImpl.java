...
public class SfConsumerServiceImpl implements ConsumerService {
    ...
    public void processMessage(Message<User> message) {
        ...
        logger.info("SfConsumerServiceImpl consumed:" + message.toString());
        logger.info("SF PAYLOAD: " + message.getPayload());
